...
const Upload = () => {
    ...
    const handleAnalyzeWithFileUpload = async ({ file, jdFile: uploadedJDFile }: { file: File; jdFile: File }) => {
        ...
        try {
            ...
            setTimeout(() => router.push(`/resume/${uuid}`), 500);
                    ...
                    {isProcessing ? (
                        ...
                        <>
                            ...
                            <p className="text-gray-600 mt-2">
                                Want to create a new resume instead? <Link href="/editor/new" className="text-blue-600 hover:underline font-semibold">Use our Resume Editor →</Link>
                            </p>
                        </>
                    )}
                    {!isProcessing && (
